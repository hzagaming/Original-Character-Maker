...
apiNetworkScenarios.forEach((s, i) => {
  catA.push(makeEntry({
    code: s.code,
    message: s.msg,
    severity: s.sev,
...
console.log('Generated', catA.length, 'entries for category A');
console.log(catA[0].substring(0, 200));
