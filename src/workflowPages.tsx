...
async function parseJsonResponse(response: Response) {
  try {
    ...
    return { error: `Unexpected response with status ${response.status}.` };
  }
}
      ...
      <section className="tool-workbench fade-up delay-2">
        <div className="tool-header">
          ...
          <div className="tool-header-actions">
            ...
            <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(configJson); }}>{copy.copyJson}</button>
            ...
            <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('style-transfer-config.json', configJson, 'application/json'); }}>{copy.downloadJson}</button>
          </div>
        </div>
              ...
              {isResultOpen && (
                <div className="result-grid">
                    ...
                    return (
                      <div className="tool-card" style={{ padding: 12 }}>
                        <div className="paper-output-card-header" style={{ marginBottom: 8 }}>
                          ...
                          <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('pageSwitch'); window.open(String(outputUrl), '_blank', 'noopener,noreferrer'); }}>{transfer.openFile}</button>
                        </div>
                        <img
                        ...
                        />
                        <div className="mini-action-row">
                          <button className="secondary-button small-button" type="button" data-sfx-handled onClick={async () => {
                            try {
                  ...
                  <CollapsibleCodePanel title={transfer.outputTitle} description={result ? transfer.resultReady : transfer.waitingResult} code={resultJson} copy={copy} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(resultJson); }}>{copy.copyResult}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('style-transfer-result.json', resultJson, 'application/json'); }}>{copy.downloadResult}</button>
                  ...
                  <CollapsibleCodePanel title={copy.errorTitle} description={error ? error.message : copy.noRecentError} code={errorJson} copy={copy} tone={error ? 'error' : 'default'} defaultOpen={Boolean(error)} autoOpenSignal={error?.message ?? null} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(errorJson); }}>{copy.copyResult}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('style-transfer-error.json', errorJson, 'application/json'); }}>{copy.downloadResult}</button>
                  ...
                  <CollapsibleCodePanel title={copy.debugTitle} description={transfer.debugDescription} code={debugJson} copy={copy} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(debugJson); }}>{copy.copyDebug}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('style-transfer-debug.json', debugJson, 'application/json'); }}>{copy.downloadDebug}</button>
                  </>} />
                </div>
              )}
            </section>
          ...
          <div className="tool-column side">
            <section className="tool-card" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              <div className="tool-card-header">
                ...
                <div className="tool-header-actions">
                  <button className="secondary-button small-button" type="button" disabled={logs.length === 0} data-sfx-handled onClick={() => { copyText(logsText); playSound('copySound'); }}>{copy.imageConverter.copyLogs}</button>
                  <button className="secondary-button small-button" type="button" disabled={logs.length === 0} data-sfx-handled onClick={() => { downloadText('tts-logs.txt', logsText); playSound('downloadSound'); }}>{copy.imageConverter.downloadLogs}</button>
                </div>
              </div>
      ...
      <section className="tool-workbench fade-up delay-2">
        <div className="tool-header">
          ...
          <div className="tool-header-actions">
            ...
            <button className="secondary-button small-button" type="button" onClick={() => importFileRef.current?.click()}>{copy.importConfig}</button>
            <input ref={importFileRef} type="file" accept="application/json,.json" hidden onChange={handleImportFile} />
            <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(exportJson); }}>{copy.copyJson}</button>
            <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('image-converter-config.json', exportJson, 'application/json'); }}>{copy.downloadJson}</button>
          </div>
        </div>
          ...
          <div className="tool-column side">
            ...
            <section className="tool-card" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              <div className="tool-card-header">
                ...
                <div className="tool-header-actions">
                  <button className="secondary-button small-button" type="button" disabled={logs.length === 0} data-sfx-handled onClick={() => { copyText(logsText); playSound('copySound'); }}>{copy.imageConverter.copyLogs}</button>
                  <button className="secondary-button small-button" type="button" disabled={logs.length === 0} data-sfx-handled onClick={() => { downloadText('converter-logs.txt', logsText); playSound('downloadSound'); }}>{copy.imageConverter.downloadLogs}</button>
                </div>
              </div>
      ...
      <section className="tool-workbench fade-up delay-2">
        <div className="tool-header">
          ...
          <div className="tool-header-actions">
            ...
            <button className="secondary-button small-button" type="button" onClick={() => importFileRef.current?.click()}>{copy.importConfig}</button>
            <input ref={importFileRef} type="file" accept="application/json,.json" hidden onChange={handleImportFile} />
            <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('character-gif-config.json', configJson, 'application/json'); }}>{copy.downloadJson}</button>
          </div>
        </div>
            ...
            <section className="tool-card">
              ...
              {isResultOpen && (
                <div className="result-grid">
                  ...
                  <CollapsibleCodePanel title={transfer.outputTitle} description={result ? transfer.resultReady : transfer.waitingResult} code={resultJson} copy={copy} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(resultJson); }}>{copy.copyResult}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('character-gif-result.json', resultJson, 'application/json'); }}>{copy.downloadResult}</button>
                    {!result?.outputUrl && status === 'success' && <button className="primary-button small-button" type="button" onClick={startWorkflow}>{transfer.redo}</button>}
                  </>} />
                  <CollapsibleCodePanel title={copy.errorTitle} description={error ? error.message : copy.noRecentError} code={errorJson} copy={copy} tone={error ? 'error' : 'default'} defaultOpen={Boolean(error)} autoOpenSignal={error?.message ?? null} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(errorJson); }}>{copy.copyResult}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('character-gif-error.json', errorJson, 'application/json'); }}>{copy.downloadResult}</button>
                    {error && <button className="secondary-button small-button" type="button" onClick={() => setShowErrorPanel(true)}>{transfer.openDetailPanel}</button>}
                  </>} />
                  <CollapsibleCodePanel title={copy.debugTitle} description={transfer.debugDescription} code={debugJson} copy={copy} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(debugJson); }}>{copy.copyDebug}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('character-gif-debug.json', debugJson, 'application/json'); }}>{copy.downloadDebug}</button>
                  </>} />
                </div>
              )}
            </section>
      ...
      <section className="tool-workbench fade-up delay-2">
        <div className="tool-header">
          ...
          <div className="tool-header-actions">
            ...
            <button className="secondary-button small-button" type="button" onClick={() => importFileRef.current?.click()}>{copy.importConfig}</button>
            <input ref={importFileRef} type="file" accept="application/json,.json" hidden onChange={handleImportFile} />
            <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('index-tts-config.json', configJson, 'application/json'); }}>{copy.downloadJson}</button>
          </div>
        </div>
            ...
            <section className="tool-card">
              ...
              {isResultOpen && (
                <div className="result-grid">
                  ...
                  <CollapsibleCodePanel title={transfer.outputTitle} description={result ? transfer.resultReady : transfer.waitingResult} code={resultJson} copy={copy} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(resultJson); }}>{copy.copyResult}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('index-tts-result.json', resultJson, 'application/json'); }}>{copy.downloadResult}</button>
                    {!result?.outputUrl && status === 'success' && <button className="primary-button small-button" type="button" onClick={startWorkflow}>{transfer.redo}</button>}
                  </>} />
                  <CollapsibleCodePanel title={copy.errorTitle} description={error ? error.message : copy.noRecentError} code={errorJson} copy={copy} tone={error ? 'error' : 'default'} defaultOpen={Boolean(error)} autoOpenSignal={error?.message ?? null} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(errorJson); }}>{copy.copyResult}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('index-tts-error.json', errorJson, 'application/json'); }}>{copy.downloadResult}</button>
                    {error && <button className="secondary-button small-button" type="button" onClick={() => setShowErrorPanel(true)}>{transfer.openDetailPanel}</button>}
                  </>} />
                  <CollapsibleCodePanel title={copy.debugTitle} description={transfer.debugDescription} code={debugJson} copy={copy} actions={<>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('copySound'); copyText(debugJson); }}>{copy.copyDebug}</button>
                    <button className="secondary-button small-button" type="button" data-sfx-handled onClick={() => { playSound('downloadSound'); downloadText('index-tts-debug.json', debugJson, 'application/json'); }}>{copy.downloadDebug}</button>
                  </>} />
                </div>
              )}
            </section>
