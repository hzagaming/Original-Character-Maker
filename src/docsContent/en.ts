...
export const docsContent: DocsContent = {
  intro: `Welcome to the Original Character Maker (OC Maker) User Manual!

OC Maker is a comprehensive tool suite designed for original character (OC) creators. Whether you're drawing character portraits, designing world settings, writing character backstories, converting characters to different art styles, generating character voices, or training custom AI models, OC Maker provides a one-stop solution.

[Document Structure]
This manual consists of three main parts:

1. Tool Guides — Detailed usage instructions for each feature module, including interface explanations, parameter descriptions, and FAQs. Each tool has its own chapter covering:
   · Feature Overview: Core capabilities and applicable scenarios
   · Button Guide: Function, shortcuts, and notes for each button
   · Parameter Details: Range, meaning, and recommended values for all adjustable parameters
   · Troubleshooting: Common error codes, root causes, and step-by-step solutions

2. Error Code Dictionary — A complete error index organized by letters and numbers. When encountering an error:
   · Note the error code (e.g., CONFIG_CORRUPTED, STYLE_TRANSFER_REQUEST_FAILED)
   · Find the corresponding category by first letter (A=Auth & Connection, B=Config & Data, C=Content & Input, etc.)
   · View severity, location, root cause, and detailed resolution steps
   · Reference related error codes and prevention tips to avoid recurrence

3. Quick Reference — Shortcut lists, supported file formats, API limits, performance optimization tips, and other cheat-sheet information.

[Quick Start]
New users are recommended to explore in this order:
Step 1: Open the Face Maker to experience the basic character creation workflow
Step 2: Try Style Transfer to convert your character to different art styles
Step 3: Use the Character Profile tool to organize detailed character settings
Step 4: Use LLM Hub to let AI help refine your world setting and plot
Step 5: Use TTS Export to give your character a voice
Step 6: Advanced users can try paper2gal to train custom LoRA models

[Search and Navigation]
- Left sidebar: Browse all chapters by tool category
- Top search: Full-text search by error code, keywords, or description
- Direct error code jump: Click codes in error panels to auto-locate entries
- Bookmarks: Add frequently used chapters to browser bookmarks

[Feedback and Support]
- Issues not covered in docs? Submit via the in-app Feedback button
- Found documentation errors or outdated content? Submit correction suggestions
- Need new features? Check the roadmap and voting in the About page

[Version Info]
Current document version: v1.3.0
Last updated: January 2025
Applicable app version: v1.3.0 and above

[Contributors]
Thanks to the following contributors for improving the documentation:
- Core documentation: OC Maker Development Team
- Japanese translation: Community volunteers
- Korean translation: Community volunteers
- Russian translation: Community volunteers
- English proofreading: Community volunteers

[Open Source License]
OC Maker is open-sourced under the MIT License. Documentation content follows the same MIT License, allowing free copying, modification, and distribution with attribution.
...
· Keyboard Shortcuts — Space to play/pause, Ctrl+Z to undo, Ctrl+Shift+Z to redo`,
    ...
    },
    {
      ...
      overview: `The Audio Converter is a dedicated audio format conversion tool. Import audio files (MP3, WAV, OGG, FLAC, M4A, AAC, WEBM) and convert them to a wide range of output formats with full control over encoding parameters. The tool processes audio entirely in the browser using the Web Audio API — no server upload is required.
