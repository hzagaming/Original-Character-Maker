...
· Error Panel — Detailed error messages with codes, causes, and solutions`,
    ...
    },
    {
      id: 'relationship-web',
      title: 'キャラ関係図',
      overview: `キャラ関係図は、オリジナルキャラクター（OC）間のつながりを可視化するインタラクティブなグラフエディタです。名前・色・メモ・アセットギャラリーからの画像を持つキャラクターノードを作成し、色分けされた関係エッジでつなぎます。

主な機能：
· 可視化キャンバス — 無限キャンバス上で自由にパン、ズーム、ノードドラッグ
· 8 種類の関係タイプ — 友達、敵、家族、恋人、師弟、ライバル、同盟、カスタム。それぞれ固有の色を持つ
· ノードエディタ — 名前の設定、スウォッチからの色選択、メモ追加、アセットギャラリーからのアバター割り当て
· エッジエディタ — 関係タイプの選択、任意のラベルとメモの追加
· アセットギャラリー連携 — キャラクターイラストを直接ノードアバターとしてインポート
· キャンバス操作 — 拡大/縮小、表示リセット、キーボードショートカット（Delete で削除、Escape で選択解除）
· データ永続化 — すべてのノードと関係をブラウザの localStorage に自動保存
· キーボードアクセシビリティ — Tab フォーカス可能なノード。Enter/Space で選択、Shift+Enter でクイックエッジ追加`,
      buttons: [
        { name: 'キャラ追加', description: '現在のビューポート中央に新しいキャラクターノードを作成します。' },
        { name: '関係追加', description: 'エッジ作成モードを開始します。まずソースノードをクリックし、次にターゲットノードをクリックして関係を作成します。' },
        { name: '編集', description: 'ノードまたはエッジ編集モーダルを開き、名前、色、アバター、タイプ、ラベル、メモを変更します。' },
        { name: '削除', description: '選択中のノードまたはエッジを削除します。ノードを削除すると、接続されているすべてのエッジも削除されます。' },
        { name: '拡大 / 縮小', description: 'キャンバスのズームレベルを調整します。マウスホイールも使用可能です。' },
        { name: '表示リセット', description: 'パンとズームをデフォルトの中央ビューにリセットします。' },
        { name: 'アイコン選択', description: 'アセットギャラリーの選択画面を開き、画像をノードのアイコンとして設定します。' },
        { name: 'アイコン削除', description: 'ノードから画像アイコンを削除し、頭文字のプレースホルダーに戻します。' },
      ],
      parameters: [
        { name: 'キャラ名', description: 'キャラクターノードの表示名。', tips: 'ラベルがノード円の下に収まるよう、短く保ってください。' },
        { name: 'ノードの色', description: 'ノードのアクセントカラー。アバターの背景と選択リングに表示されます。', tips: 'キャンバスの背景と良好なコントラストを持つ色を選んでください。' },
        { name: 'ノードのメモ', description: 'ノードに付加される任意の自由テキストメモ。', tips: 'キャラクターの背景設定、特徴、または備忘録に使用できます。' },
        { name: '関係タイプ', description: '2 人のキャラクター間の関係カテゴリ。', tips: 'プリセットのタイプが合わない場合はカスタムを選択してください。' },
        { name: '関係ラベル', description: '関係線に表示される任意の短いラベル。', tips: '例：「幼馴染」「2020 年からの宿敵」。' },
        { name: '関係メモ', description: '関係に付加される任意の自由テキストメモ。', tips: '関係の歴史、イベント、またはストーリー背景に使用できます。' },
      ],
      errors: [
        {
          code: 'NO_NODES',
          message: 'グラフにキャラがいません',
          severity: 'info',
          category: 'B. 設定とデータ',
          location: 'ページ：キャラ関係図 → 領域：キャンバス',
          cause: 'まだノードが作成されていないため、グラフは空です。',
          solution: '「キャラ追加」をクリックして最初のノードを作成してください。',
          steps: ['キャラ追加ボタンをクリック', '名前を入力', '保存をクリック'],
          relatedCodes: [],
          prevention: 'N/A',
        },
        {
          code: 'STORAGE_FULL',
          message: 'ブラウザストレージが満杯です',
          severity: 'error',
          category: 'F. ブラウザとパフォーマンス',
          location: 'ページ：キャラ関係図 → 領域：保存',
          cause: 'ブラウザの localStorage クォータを超過し、ノードや関係が保存できません。',
          solution: 'ブラウザのストレージを解放するか、データをエクスポートしてバックアップしてください。',
          steps: ['不要な localStorage データを削除', '関係データをエクスポート', 'ページを再読み込み'],
    ...
    },
    {
      id: 'character-card',
      title: 'キャラクターカード',
      overview: `キャラクターカードエクスポーターは、キャラクター情報、イラスト、プロフィール項目、タグ、関係データを組み合わせて、美しく共有可能な PNG カードを作成します。3 種類のテンプレート（ミニマル、詳細、ギャラリー）から選択し、テーマカラーと背景をカスタマイズして、ワンクリックでエクスポートできます。

主な機能：
· 3 種類のカードテンプレート — ミニマル（コンパクトな肖像カード）、詳細（ヒーローイメージ付きの完全プロフィール）、ギャラリー（関係グリッド付きの中央展示）
· アセットギャラリー連携 — アバターとメインビジュアル画像をアセットギャラリーから直接選択
· キャラ関係図連携 — 関連キャラクターとその関係タイプを自動的にインポート（オプション）
· カスタムプロフィール項目 — 任意の数のラベル付き項目を追加（年齢、身長、誕生日、性格など）
· タグとカラー — キャラクターを分類するためのカラータグを割り当て
· テーマカスタマイズ — 19 種類のプリセットからアクセントカラーを選択；背景スタイル（単色、グラデーション、ドットパターン）を選択
· ワンクリックエクスポート — html-to-image で 2 倍解像度でレンダリングし、PNG としてダウンロード`,
      buttons: [
        { name: 'エクスポート', description: '現在のカードプレビューを高解像度 PNG 画像としてレンダリングし、デバイスにダウンロードします。' },
        { name: 'アバター選択', description: 'アセットギャラリーの選択画面を開き、カード用の正方形アバター画像を選びます。' },
        { name: 'メインビジュアル選択', description: 'アセットギャラリーの選択画面を開き、詳細およびギャラリーテンプレート用のヒーロー/バナー画像を選びます。' },
        { name: 'タグ追加', description: '新しいカラータグを作成します。色は自動的にランダムに割り当てられます。' },
        { name: '項目追加', description: 'ラベルと値を持つ新しいカスタムプロフィール項目を追加します。' },
        { name: '項目/タグ削除', description: 'カードから特定のプロフィール項目またはタグを削除します。' },
        { name: 'テンプレート切り替え', description: 'ミニマル、詳細、ギャラリーのカードレイアウトを切り替えます。' },
        { name: '背景スタイル', description: '単色背景、アクセントグラデーションオーバーレイ、ドットパターンオーバーレイを切り替えます。' },
      ],
      parameters: [
        { name: 'キャラクター名', description: 'カード上のキャラクターの主要表示名。', tips: '必須。名前が入力されるまでエクスポートボタンは無効です。' },
        { name: '別名', description: 'オプションの二次的な名前またはニックネーム。', tips: 'キャラクターに別名がない場合は空のままにしてください。' },
        { name: 'テーマカラー', description: '枠線、ハイライト、グラデーション背景に使用されるアクセントカラー。', tips: 'キャラクターのイラストに合う色を選んでください。' },
        { name: 'キャラクター紹介', description: 'カードに表示される自由テキストの説明または背景設定。', tips: 'ミニマルテンプレートでは簡潔に；詳細およびギャラリーテンプレートにはより多くのスペースがあります。' },
        { name: '関係をインポート', description: '有効にすると、ツールはキャラ関係図のデータを読み取り、関連キャラクターを自動入力します。', tips: 'ツールは「キャラクター名」フィールドと完全に一致する名前のノードを探します。' },
        { name: 'テンプレート', description: 'エクスポートされるカードの視覚レイアウト。', tips: '詳細テンプレートは完全なプロフィールに最適；ギャラリーテンプレートは視覚重視の展示に最適。' },
      ],
      errors: [
        {
          code: 'NO_NAME',
          ...
          severity: 'warning',
          category: 'B. 設定とデータ',
          location: 'ページ：キャラクターカード → 領域：エクスポートボタン',
          cause: 'キャラクター名を入力する前にエクスポートボタンがクリックされました。',
          solution: '「キャラクター名」フィールドに少なくとも 1 文字入力してください。',
          steps: ['キャラクター名の入力欄をクリック', '名前を入力', 'もう一度エクスポートをクリック'],
          relatedCodes: [],
          prevention: 'N/A',
        },
        {
          code: 'EXPORT_FAILED',
          message: 'カードのエクスポートに失敗しました',
          severity: 'error',
          category: 'F. ブラウザとパフォーマンス',
          location: 'ページ：キャラクターカード → 領域：エクスポート',
          cause: 'ブラウザが画像レンダリングをブロックした、プレビュー DOM が切り離された、または html-to-image がクロスオリジン画像に遭遇した。',
          solution: '選択したすべての画像がアセットギャラリー（Data URL）からのものであることを確認してください。画像を再選択するか、ページを再読み込みしてください。',
          steps: ['アセットギャラリーに画像がまだ存在するか確認', 'アバター/メインビジュアルを再選択', 'もう一度エクスポートをクリック'],
          relatedCodes: [],
...
・永続ストレージ —— すべてのイベントは自動的にブラウザの localStorage に保存されます`,
    ...
    },
    {
      ...
      title: '世界百科事典',
      overview: `世界百科事典は、オリジナルの世界観を構築するための構造化された知識管理ツールです。場所、組織、種族、イベント、アイテム、概念、およびカスタムカテゴリのエントリーを作成できます。各エントリーはタグ、関係ウェブからの関連キャラクター、および自由記述のコンテンツをサポートしています。リスト表示またはカードグリッド表示で閲覧でき、検索とカテゴリ絞り込みが可能です。百科事典全体をJSONとしてエクスポートし、バックアップや共有ができます。

主な機能：
· 7つのエントリーカテゴリ — 場所（緑）、組織（青）、種族（琥珀）、イベント（赤）、アイテム（紫）、概念（シアン）、カスタム（灰）
· タグシステム — エントリーに任意の数の自由テキストタグを付与し、分類と絞り込みが可能
· 関係ウェブリンク — 関連キャラクターをエントリーに紐付け；キャラクターの色がカード上のドットとして表示されます
· 2つの表示モード — カードグリッド表示（視覚的閲覧）、コンパクトリスト表示（高密度スキャン）
· 検索と絞り込み — タイトル、内容、タグを対象とした全文検索；リアルタイムカウンター付きカテゴリチップ
· JSONエクスポート — 百科事典全体を整形済みJSONとしてクリップボードにコピー
· 永続ストレージ — すべてのエントリーは自動的にブラウザのlocalStorageに保存されます`,
      buttons: [
        { name: 'エントリーを追加', description: '新しい百科事典エントリーを作成するためのエントリー編集モーダルを開きます。' },
        { name: 'エントリーを編集', description: '既存のエントリーを編集モーダルで開き、フィールドを変更します。' },
        { name: 'エントリーを削除', description: '確認後、百科事典からエントリーを削除します。' },
        { name: 'JSONをエクスポート', description: '百科事典のデータセット全体を整形済みJSONとしてクリップボードにコピーします。' },
        { name: '検索', description: 'タイトル、内容、またはタグに一致するキーワードを入力してエントリーを絞り込みます。' },
        { name: 'カテゴリ絞り込み', description: 'カテゴリチップをクリックして、そのタイプのエントリーのみを表示します。もう一度クリックして解除します。' },
        { name: '表示切替', description: 'カードグリッド表示とコンパクトリスト表示を切り替えます。' },
        { name: 'キャラクターを紐付け', description: '関係ウェブのキャラクターをこのエントリーに関連付けます。' },
      ],
      parameters: [
        { name: 'タイトル', description: '百科事典エントリーの表示名です。', tips: '検索しやすいよう、簡潔で一意な名前にしてください。' },
        { name: 'カテゴリ', description: 'エントリーの色とアイコンを決定する分類です。', tips: '6つのプリセットのいずれにも当てはまらない場合は、「カスタム」を使用してください。' },
        { name: '内容', description: 'エントリーを詳細に説明する本文テキストです。', tips: '自由形式のテキストが使用可能です。設定、歴史、外見の説明、ルールなどを記述してください。' },
        { name: 'タグ', description: 'プリセットのカテゴリ以外で追加分類するための自由テキストラベルです。', tips: '例："magic"、"faction-A"、"main-city"、"legendary"' },
        { name: '関連キャラクター', description: 'このエントリーに紐付けられた関係ウェブのキャラクターです。', tips: '組織に所属するキャラクター、場所に住むキャラクター、イベントに参加したキャラクターを示すのに便利です。' },
      ],
      errors: [
        {
          code: 'NO_ENTRIES',
          ...
          severity: 'info',
          category: 'B. 設定とデータ',
          location: 'ページ：世界百科事典 → 領域：コンテンツエリア',
          cause: 'まだエントリーが作成されていません。',
          solution: '「エントリーを追加」をクリックして最初の百科事典エントリーを作成してください。',
          steps: ['エントリーを追加をクリック', 'タイトルとカテゴリを入力', '保存をクリック'],
          relatedCodes: [],
          prevention: 'N/A',
        },
        {
          code: 'EXPORT_FAILED',
          message: 'JSONエクスポートに失敗しました',
          severity: 'error',
          category: 'F. ブラウザとパフォーマンス',
          location: 'ページ：世界百科事典 → 領域：エクスポートボタン',
          cause: 'ブラウザがクリップボードアクセスをブロックしたか、データが大きすぎます。',
          solution: 'ページにクリップボード権限があることを確認してください。データが非常に大きい場合は、エクスポート前にいくつかのエントリーを削除してみてください。',
          steps: ['ブラウザの権限を確認', '必要に応じてエントリー数を減らす', 'もう一度JSONをエクスポートをクリック'],
          relatedCodes: [],
          prevention: 'JSONが巨大化しないよう、定期的に小さなバッチでエクスポートしてください。',
        },
      ],
    },
    {
