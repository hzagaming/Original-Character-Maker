...
· Keyboard Shortcuts — Space to play/pause, Ctrl+Z to undo, Ctrl+Shift+Z to redo`,
    ...
    },
    {
      id: 'audio-converter',
      title: '오디오 포맷 변환기',
      overview: `오디오 포맷 변환기는 전용 오디오 포맷 변환 도구입니다. 오디오 파일(MP3, WAV, OGG, FLAC, M4A, AAC, WEBM)을 가져와 인코딩 매개변수를 완전히 제어하여 다양한 출력 형식으로 변환합니다. 이 도구는 Web Audio API를 사용하여 브라우저 내에서 오디오를 완전히 처리합니다 — 서버 업로드가 필요하지 않습니다.
...
· Error Panel — Detailed error messages with codes, causes, and solutions`,
    ...
    },
    {
      id: 'relationship-web',
      title: '캐릭터 관계망',
      overview: `캐릭터 관계망은 오리지널 캐릭터(OC) 간의 연결을 시각화하는 인터랙티브 그래프 편집기입니다. 이름, 색상, 메모, 에셋 갤러리의 이미지를 가진 캐릭터 노드를 생성하고, 색상으로 구분된 관계 선으로 연결하세요.

주요 기능:
· 시각화 캔버스 — 무한 캔버스에서 자유롭게 이동, 확대/축소, 노드 드래그
· 8가지 관계 유형 — 친구, 적, 가족, 연인, 스승, 라이벌, 동맹, 사용자 정의. 각각 고유한 색상 보유
· 노드 에디터 — 이름 설정, 색상 팔레트 선택, 메모 추가, 에셋 갤러리에서 아바타 할당
· 엣지 에디터 — 관계 유형 선택, 선택적 라벨과 메모 추가
· 에셋 갤러리 연동 — 캐릭터 일러스트를 노드 아바타로 직접 가져오기
· 캔버스 조작 — 확대/축소, 보기 재설정, 키보드 단축키(Delete 삭제, Escape 선택 해제)
· 데이터 지속성 — 모든 노드와 관계를 브라우저 localStorage에 자동 저장
· 키보드 접근성 — Tab으로 노드 포커스, Enter/Space로 선택, Shift+Enter로 빠른 관계 추가`,
      buttons: [
        { name: '캐릭터 추가', description: '현재 뷰포트 중앙에 새 캐릭터 노드를 생성합니다.' },
        { name: '관계 추가', description: '엣지 생성 모드를 시작합니다. 먼저 소스 노드를 클릭한 다음 대상 노드를 클릭하여 관계를 생성합니다.' },
        { name: '편집', description: '노드 또는 엣지 편집 모달을 열어 이름, 색상, 아바타, 유형, 라벨, 메모를 수정합니다.' },
        { name: '삭제', description: '선택한 노드 또는 엣지를 제거합니다. 노드를 삭제하면 연결된 모든 엣지도 함께 삭제됩니다.' },
        { name: '확대 / 축소', description: '캔버스 확대/축소 수준을 조정합니다. 마우스 휠도 지원됩니다.' },
        { name: '보기 재설정', description: '이동과 확대/축소를 기본 중앙 보기로 재설정합니다.' },
        { name: '아바타 선택', description: '에셋 갤러리 선택기를 열어 이미지를 노드 아바타로 설정합니다.' },
        { name: '아바타 삭제', description: '노드에서 이미지 아바타를 제거하고 이니셜 자리 표시자로 되돌립니다.' },
      ],
      parameters: [
        { name: '캐릭터 이름', description: '캐릭터 노드의 표시 이름입니다.', tips: '노드 원 아래에 라벨이 들어갈 수 있도록 짧게 유지하세요.' },
        { name: '노드 색상', description: '노드의 강조색으로, 아바타 배경과 선택 링에 표시됩니다.', tips: '캔버스 배경과 대비가 잘 되는 색상을 선택하세요.' },
        { name: '노드 메모', description: '노드에 첨부된 선택적 자유 텍스트 메모입니다.', tips: '캐릭터 배경 이야기, 특성 또는 알림에 사용할 수 있습니다.' },
        { name: '관계 유형', description: '두 캐릭터 간의 관계 카테고리입니다.', tips: '프리셋 유형이 맞지 않으면 사용자 정의를 선택하세요.' },
        { name: '관계 라벨', description: '관계 선 위에 표시되는 선택적 짧은 라벨입니다.', tips: '예: 「소꿉친구」, 「2020년부터의 숙적」.' },
        { name: '관계 메모', description: '관계에 첨부된 선택적 자유 텍스트 메모입니다.', tips: '관계 역사, 이벤트 또는 스토리 맥락에 사용할 수 있습니다.' },
      ],
      errors: [
        {
          code: 'NO_NODES',
          message: '그래프에 캐릭터가 없습니다',
          severity: 'info',
          category: 'B. 설정 및 데이터',
          location: '페이지: 캐릭터 관계망 → 영역: 캔버스',
          cause: '아직 노드가 생성되지 않아 그래프가 비어 있습니다.',
          solution: '「캐릭터 추가」를 클릭하여 첫 번째 노드를 생성하세요.',
          steps: ['캐릭터 추가 버튼 클릭', '이름 입력', '저장 클릭'],
          relatedCodes: [],
          prevention: 'N/A',
        },
        {
          ...
          location: '페이지: 캐릭터 관계망 → 영역: 저장',
          cause: '브라우저 localStorage 할당량을 초과하여 노드나 관계를 저장할 수 없습니다.',
          solution: '브라우저 저장 공간을 확보하거나 데이터를 낳아 백업하세요.',
          steps: ['사용하지 않는 localStorage 데이터 삭제', '관계 데이터 낳아오기', '페이지 새로고침'],
    ...
    },
    {
      id: 'character-card',
      title: '캐릭터 카드',
      overview: `캐릭터 카드 내보내기 도구는 캐릭터 정보, 일러스트, 프로필 필드, 태그 및 관계 데이터를 아름답고 공유 가능한 PNG 카드로 결합합니다. 세 가지 템플릿(미니멀, 상세, 갤러리) 중에서 선택하고, 테마 색상과 배경을 사용자 지정한 후 한 번의 클릭으로 내보냅니다.

주요 기능:
· 세 가지 카드 템플릿 — 미니멀(컴팩트한 초상 카드), 상세(히어로 이미지가 포함된 전체 프로필), 갤러리(관계 그리드가 있는 중앙 쇼케이스)
· 에셋 갤러리 연동 — 에셋 갤러리에서 아바타와 메인 비주얼 이미지를 직접 선택
· 캐릭터 관계망 연동 — 관련 캐릭터와 관계 유형을 선택적으로 자동 가져오기
· 사용자 지정 프로필 필드 — 레이블이 있는 필드를 원하는 만큼 추가(나이, 키, 생일, 성격 등)
· 태그 및 색상 — 캐릭터를 분류하기 위해 색상 태그 할당
· 테마 사용자 지정 — 19가지 프리셋 중 강조색 선택; 배경 스타일(단색, 그라데이션 또는 도트 패턴) 선택
· 원클릭 내보내기 — html-to-image를 통해 2배 해상도로 카드를 렌더링하고 PNG로 다운로드`,
      buttons: [
        { name: '카드 내보내기', description: '현재 카드 미리보기를 고해상도 PNG 이미지로 렌더링하여 장치에 다운로드합니다.' },
        { name: '아바타 선택', description: '에셋 갤러리 선택기를 열어 카드용 정사각형 아바타 이미지를 선택합니다.' },
        { name: '메인 비주얼 선택', description: '에셋 갤러리 선택기를 열어 상세 및 갤러리 템플릿용 히어로/배너 이미지를 선택합니다.' },
        { name: '태그 추가', description: '새로운 색상 태그를 생성합니다. 색상은 자동으로 무작위로 할당됩니다.' },
        { name: '필드 추가', description: '레이블과 값이 있는 새로운 사용자 지정 프로필 필드를 추가합니다.' },
        { name: '필드/태그 삭제', description: '카드에서 특정 프로필 필드 또는 태그를 삭제합니다.' },
        { name: '템플릿 전환', description: '미니멀, 상세, 갤러리 카드 레이아웃 간 전환합니다.' },
        { name: '배경 스타일', description: '단색 배경, 강조색 그라데이션 오버레이, 도트 패턴 오버레이 간 전환합니다.' },
      ],
      parameters: [
        { name: '캐릭터 이름', description: '카드에 표시되는 캐릭터의 기본 표시 이름입니다.', tips: '필수. 이름을 입력하기 전까지 내보내기 버튼이 비활성화됩니다.' },
        { name: '별명', description: '선택적인 보조 이름 또는 별칭입니다.', tips: '캐릭터에 별명이 없으면 비워 두세요.' },
        { name: '테마 색상', description: '테두리, 강조 표시 및 그라데이션 배경에 사용되는 강조색입니다.', tips: '캐릭터 일러스트와 잘 어울리는 색상을 선택하세요.' },
        { name: '캐릭터 소개', description: '카드에 표시되는 자유 텍스트 설명 또는 배경 이야기입니다.', tips: '미니멀 템플릿에서는 간결하게; 상세 및 갤러리 템플릿에는 더 많은 공간이 있습니다.' },
        { name: '관계 가져오기', description: '활성화되면 도구가 캐릭터 관계망 데이터를 읽고 관련 캐릭터를 자동으로 채웁니다.', tips: '도구는 \'캐릭터 이름\' 필드와 정확히 일치하는 이름의 노드를 찾습니다.' },
        { name: '템플릿', description: '내보내는 카드의 시각적 레이아웃입니다.', tips: '상세 템플릿은 전체 프로필에 가장 적합합니다; 갤러리 템플릿은 시각 중심 쇼케이스에 가장 적합합니다.' },
      ],
      errors: [
        {
          code: 'NO_NAME',
          message: '캐릭터 이름이 비어 있습니다',
          severity: 'warning',
          category: 'B. 설정 및 데이터',
          location: '페이지: 캐릭터 카드 → 영역: 내보내기 버튼',
          cause: '캐릭터 이름을 입력하기 전에 내보내기 버튼을 클릭했습니다.',
          solution: '캐릭터 이름 필드에 최소 한 글자를 입력하세요.',
          steps: ['캐릭터 이름 입력란 클릭', '이름 입력', '카드 내보내기 다시 클릭'],
          relatedCodes: [],
          prevention: 'N/A',
        },
        {
          ...
          severity: 'error',
          category: 'F. 브라우저 및 성능',
          location: '페이지: 캐릭터 카드 → 영역: 내보내기',
          cause: '브라우저가 이미지 렌더링을 차단했거나, 미리보기 DOM이 분리되었거나, html-to-image가 교차 출처 이미지를 만났습니다.',
          solution: '선택한 모든 이미지가 에셋 갤러리(Data URL)에서 가져온 것인지 확인하세요. 이미지를 다시 선택하거나 페이지를 새로고침해 보세요.',
          steps: ['에셋 갤러리에 이미지가 여전히 존재하는지 확인', '아바타/메인 이미지를 다시 선택', '내보내기 다시 클릭'],
          relatedCodes: [],
...
· 영구 저장 — 모든 이벤트는 자동으로 브라우저 localStorage에 저장됩니다`,
    ...
    },
    {
      ...
      title: '세계 백과사전',
      overview: `세계 백과사전은 오리지널 세계관을 구축하기 위한 구조화된 지식 관리 도구입니다. 장소, 조직, 종족, 사건, 아이템, 개념 및 사용자 정의 카테고리에 대한 항목을 생성하세요. 각 항목은 태그, 관계 웹에서 연결된 캐릭터, 자유 텍스트 콘텐츠를 지원합니다. 목록 보기와 카드 그리드 보기로 탐색할 수 있으며 검색 및 카테고리 필터링이 가능합니다. 전체 백과사전을 JSON으로 내보내 백업하거나 공유할 수 있습니다.

주요 기능:
· 7가지 항목 카테고리 — 장소(녹색), 조직(파란색), 종족(황색), 사건(빨간색), 아이템(보라색), 개념(청록색), 사용자 정의(회색)
· 태그 시스템 — 항목에 원하는 수의 자유 텍스트 태그를 할당하여 분류하고 필터링
· 관계 웹 연결 — 관계 웹의 캐릭터를 항목에 연결; 캐릭터 색상이 항목 카드에 점으로 표시됨
· 이중 보기 모드 — 카드 그리드는 시각적 탐색용, 컴팩트 목록은 밀도 높은 스캔용
· 검색 및 필터 — 제목, 내용, 태그 전체 텍스트 검색; 실시간 카운터가 있는 카테고리 칩
· JSON 내보내기 — 전체 백과사전 데이터를 서식이 지정된 JSON으로 클립보드에 복사
· 영구 저장 — 모든 항목이 브라우저 localStorage에 자동 저장됨`,
      buttons: [
        { name: '항목 추가', description: '새 백과사전 항목을 만들기 위해 항목 편집 모달을 엽니다.' },
        { name: '항목 편집', description: '기존 항목을 편집기 모달에서 열어 필드를 수정합니다.' },
        { name: '항목 삭제', description: '확인 후 백과사전에서 항목을 제거합니다.' },
        { name: 'JSON 내보내기', description: '전체 백과사전 데이터 세트를 서식이 지정된 JSON으로 클립보드에 복사합니다.' },
        { name: '검색', description: '제목, 내용 또는 태그와 일치하는 키워드를 입력하여 항목을 필터링합니다.' },
        { name: '카테고리 필터', description: '카테고리 칩을 클릭하면 해당 유형의 항목만 표시됩니다. 다시 클릭하면 필터가 해제됩니다.' },
        { name: '보기 전환', description: '카드 그리드 보기와 컴팩트 목록 보기를 전환합니다.' },
        { name: '캐릭터 연결', description: '관계 웹의 캐릭터를 이 항목과 관련된 것으로 전환합니다.' },
      ],
      parameters: [
        { name: '제목', description: '백과사전 항목의 표시 이름입니다.', tips: '검색하기 쉽도록 간결하고 고유하게 작성하세요.' },
        { name: '카테고리', description: '항목의 색상과 아이콘을 결정하는 분류입니다.', tips: '6가지 사전 설정 중 어느 것도 해당 항목 유형에 맞지 않으면 사용자 정의를 사용하세요.' },
        { name: '내용', description: '항목을 자세히 설명하는 본문 텍스트입니다.', tips: '자유 형식 텍스트를 지원합니다. 배경 이야기, 역사, 물리적 설명 또는 규칙을 작성하세요.' },
        { name: '태그', description: '사전 설정 카테고리 외에 추가 분류를 위한 자유 텍스트 레이블입니다.', tips: '예: "magic", "faction-A", "main-city", "legendary".' },
        { name: '관련 캐릭터', description: '이 항목에 연결된 관계 웹의 캐릭터입니다.', tips: '조직에 속한 캐릭터, 특정 위치에 사는 캐릭터, 이벤트에 참여한 캐릭터를 표시하는 데 유용합니다.' },
      ],
      errors: [
        {
          code: 'NO_ENTRIES',
          message: '백과사전이 비어 있습니다',
          severity: 'info',
          category: 'B. 설정 및 데이터',
          location: '페이지: 세계 백과사전 → 영역: 콘텐츠 영역',
          cause: '아직 항목이 생성되지 않았습니다.',
          solution: '첫 번째 백과사전 항목을 만들려면 "항목 추가"를 클릭하세요.',
          steps: ['항목 추가 클릭', '제목과 카테고리 입력', '저장 클릭'],
          relatedCodes: [],
          prevention: 'N/A',
        },
        {
          ...
          severity: 'error',
          category: 'F. 브라우저 및 성능',
          location: '페이지: 세계 백과사전 → 영역: 내보내기 버튼',
          cause: '브라우저가 클립보드 접근을 차단했거나 데이터가 너무 큽니다.',
          solution: '페이지에 클립보드 권한이 있는지 확인하세요. 데이터가 매우 큰 경우 내보내기 전에 일부 항목을 삭제해 보세요.',
          steps: ['브라우저 권한 확인', '필요시 항목 수 줄이기', 'JSON 내보내기 다시 클릭'],
          relatedCodes: [],
          prevention: 'JSON이 너무 커지지 않도록 정기적으로 소량 배치로 내보내기하세요.',
        },
      ],
    },
    {
