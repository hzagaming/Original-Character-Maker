...
=======
        ...
        category: 'B. 配置与数据',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '导入的 JSON 中包含重复的键名。',
        solution: '清理重复键，或使用去重策略。',
        steps: [
          '检查导入文件中的重复键',
          '决定保留哪个值',
          '手动删除重复键',
...
=======
          ...
          category: 'D. 模型与生成',
          location: '页面：LLM Hub / 转画风 / TTS / Paper2Gal → 区域：AI 生成区域',
          cause: '请求的模型 ID 或路径不存在，或模型尚未下载。',
          solution: '确认模型 ID 正确，下载缺失的模型。',
          steps: [
            '检查模型 ID 拼写',
            '确认模型是否已下载',
            '从模型仓库下载',
...
=======
        ...
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '请求体不是有效的 JSON，或缺少必填字段。',
        solution: '检查请求体格式，确保是有效的 JSON。',
        steps: [
        ...
        prevention: '使用客户端 SDK 自动生成请求，避免手动构建。',
      },
      {
        code: '401_TOKEN_EXPIRED',
        message: 'Token 已过期（401）',
        severity: 'error',
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '认证令牌已超过有效期。',
        solution: '刷新令牌，或使用长效令牌。',
        steps: [
          '调用刷新令牌接口获取新 token',
          '检查令牌的有效期配置',
          '实现自动刷新机制',
        ...
        prevention: '实现 token 自动刷新，在过期前提前更新。',
      },
      {
        code: '403_RESOURCE_FORBIDDEN',
        message: '禁止访问该资源（403）',
        ...
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '有认证信息，但权限不足以访问特定资源。',
        solution: '申请资源访问权限，或切换到有权访问的账户。',
        steps: [
          '确认当前用户身份',
          '检查资源的访问控制列表',
          '联系资源所有者授权',
        ...
        prevention: '设计细粒度的权限模型，提前进行权限检查。',
      },
      {
>>>>>>> 71713c9c8d8b46edb0c1c6965aeee2724da7a57a
...
=======
        code: '406_NOT_ACCEPTABLE',
        message: '无法提供可接受的内容（406）',
        severity: 'warning',
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '请求的 Accept 头与服务器能提供的格式不匹配。',
        solution: '修改 Accept 头，或请求服务器支持该格式。',
        steps: [
          '检查请求中的 Accept 头',
          '确认服务器支持的响应格式',
          '修改 Accept 为服务器支持的格式',
      ...
      },
      {
        ...
        location: '页面：任意工具 → 区域：错误面板',
        cause: '服务器在等待完整请求时超时。',
        solution: '检查网络连接，减少请求体大小，或增加超时时间。',
        steps: [
          '检查网络连接稳定性',
          '减少请求体大小',
          '增加客户端请求超时设置',
        ...
        prevention: '保持网络稳定，对大请求使用分块或流式传输。',
      },
      {
>>>>>>> 71713c9c8d8b46edb0c1c6965aeee2724da7a57a
...
=======
        ...
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '请求中的 If-Match/If-None-Match 等前置条件不满足。',
        solution: '获取最新资源状态，更新条件后重试。',
        steps: [
          '重新获取资源的 ETag 或 Last-Modified',
          '更新请求中的条件头',
          '重试请求',
          '如果条件持续失败则检查逻辑',
        ],
        prevention: '在修改前总是获取最新资源状态。',
      },
      {
        code: '416_RANGE_NOT_SATISFIABLE',
        message: '请求范围不满足（416）',
        ...
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '请求的 Range 头超出了资源的实际大小。',
        solution: '检查资源大小，调整 Range 范围。',
        steps: [
          '获取资源的实际大小（Content-Length）',
          '调整 Range 头在有效范围内',
          '使用完整的资源请求作为 fallback',
          '实现自适应分块下载',
        ],
        prevention: '分块下载前先确认资源总大小。',
      },
      {
>>>>>>> 71713c9c8d8b46edb0c1c6965aeee2724da7a57a
...
=======
        code: '451_UNAVAILABLE_FOR_LEGAL_REASONS',
        message: '因法律原因不可用（451）',
        severity: 'error',
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '内容因版权、地区限制等法律原因被阻止。',
        solution: '更换内容来源，或联系法律部门。',
        steps: [
          '确认内容的法律状态',
          '寻找替代内容来源',
          '联系法务团队确认合规性',
...
=======
      {
        code: '505_HTTP_VERSION_NOT_SUPPORTED',
        message: 'HTTP 版本不支持（505）',
        severity: 'error',
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '服务器不支持请求中使用的 HTTP 协议版本。',
        solution: '使用服务器支持的 HTTP 版本（通常是 HTTP/1.1）。',
        steps: [
          '检查请求使用的 HTTP 版本',
          '降级到 HTTP/1.1',
          '确认服务器支持 HTTP/2',
        ...
        prevention: '客户端默认使用 HTTP/1.1，服务器支持多版本。',
      },
      {
        code: '507_INSUFFICIENT_STORAGE',
        message: '服务器存储空间不足（507）',
        severity: 'error',
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '服务器磁盘空间已满，无法处理请求。',
        solution: '清理服务器存储，或扩容磁盘。',
        steps: [
          '检查服务器磁盘使用情况',
          '清理日志和临时文件',
          '删除不必要的旧数据',
      ...
      },
      {
        ...
        category: '0~9. HTTP 状态码',
        location: '页面：任意工具 → 区域：错误面板',
        cause: '请求在处理过程中检测到无限重定向或循环。',
        solution: '检查重定向配置，打破循环。',
        steps: [
          '检查服务器重定向规则',
          '确认没有循环重定向',
          '使用绝对 URL 避免相对路径问题',
        ...
        prevention: '重定向配置使用绝对路径，限制最大跳转次数。',
      },
>>>>>>> 71713c9c8d8b46edb0c1c6965aeee2724da7a57a
      ],
    },
