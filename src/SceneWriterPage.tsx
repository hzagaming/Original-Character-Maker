...
const UI_COPY: Record<string, Record<string, string>> = {
  zh: {
    ...
    copySuffix: '副本',
    untitledScene: '未命名场景',
    generatedBy: '由 OC Maker 场景剧本工坊生成',
  ...
  ja: {
    ...
    copySuffix: 'コピー',
    untitledScene: '無名シーン',
    generatedBy: 'OC Maker シーン脚本スタジオで生成',
  ...
  en: {
    ...
    generatedBy: 'Generated by OC Maker Scene Writer',
  ...
  ru: {
    ...
    defaultCastB: 'Второстепенный B',
    defaultCastC: 'Второстепенный B',
    copySuffix: 'Копия',
    untitledScene: 'Безымянная сцена',
    generatedBy: 'Создано в студии сценариев OC Maker',
  ...
  ko: {
    ...
    defaultCastC: '조연B',
    copySuffix: '복사본',
    untitledScene: '제목 없는 장면',
    generatedBy: 'OC Maker 장면 각본 공방에서 생성',
...
export default function SceneWriterPage({
  ...
  const duplicateScene = useCallback((scene: Scene) => {
    ...
    const copyScene: Scene = {
      ...scene,
      id: uid(),
      title: `${scene.title || copy.newScene} (${copy.copySuffix})`,
  ...
  const generateMarkdown = useCallback((scene: Scene): string => {
    const lines = [
      `# ${scene.title || copy.untitledScene}`,
      '',
