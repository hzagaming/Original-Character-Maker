...
export type FeatureScreen = 'home' | 'face-maker' | 'style-transfer' | 'character-gif' | 'index-tts' | 'prompt-suite' | 'llm-hub' | 'tts-export' | 'paper2gal' | 'image-converter' | 'audio-editor' | 'audio-converter' | 'asset-gallery' | 'docs';
